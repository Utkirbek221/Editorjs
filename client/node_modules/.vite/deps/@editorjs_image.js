...
var F = ((C) => (C.Empty = "empty", C.Uploading = "uploading", C.Filled = "filled", C))(F || {});
var x = class {
  /**
  ...
  fillImage(a) {
    ...
    let i = "load";
    r === "VIDEO" && (c.autoplay = true, c.loop = true, c.muted = true, c.playsinline = true, i = "loadeddata"), this.nodes.imageEl = S(r, this.CSS.imageEl, c), this.nodes.imageEl.addEventListener(i, () => {
      this.toggleStatus(
        "filled"
        /* Filled */
  ...
  (function(r, c) {
    ...
    return function(r) {
      ...
      function i(o) {
        ...
        var n = c[o] = { i: o, l: false, exports: {} };
        return r[o].call(n.exports, n, n.exports, i), n.l = true, n.exports;
      }
      return i.m = r, i.c = c, i.d = function(o, n, d) {
        i.o(o, n) || Object.defineProperty(o, n, { enumerable: true, get: d });
      }, i.r = function(o) {
        ...
        if (i.r(d), Object.defineProperty(d, "default", { enumerable: true, value: o }), 2 & n && typeof o != "string") for (var b in o) i.d(d, b, (function(u) {
          return o[u];
        }).bind(null, b));
        return d;
      }, i.n = function(o) {
      ...
      (function(o) {
        ...
        function f(e, l) {
          ...
          e._state !== 0 ? (e._handled = true, u._immediateFn(function() {
      ...
      var n, d, b, u, f, p, y, w = i(8), v = (d = function(t) {
        return new Promise(function(e, l) {
          ...
          }, false), s.addEventListener("progress", function(m) {
            var h = Math.round(m.loaded / m.total * 100), k = Math.ceil(h * (100 - g) / 100) + g;
            t.progress(Math.min(k, 100));
          }, false), s.onreadystatechange = function() {
            if (s.readyState === 4) {
              var m = s.response;
              try {
                m = JSON.parse(m);
      ...
      (function(o, n) {
        (function(d, b) {
          if (!d.setImmediate) {
            var u, f, p, y, w, v = 1, t = {}, e = false, l = d.document, s = Object.getPrototypeOf && Object.getPrototypeOf(d);
            ...
            }, d.addEventListener ? d.addEventListener("message", w, false) : d.attachEvent("onmessage", w), u = function(h) {
              d.postMessage(y + h, "*");
      ...
      }, n.title = "browser", n.browser = true, n.env = {}, n.argv = [], n.version = "", n.versions = {}, n.on = l, n.addListener = l, n.once = l, n.off = l, n.removeListener = l, n.removeAllListeners = l, n.emit = l, n.prependListener = l, n.prependOnceListener = l, n.listeners = function(s) {
        return [];
      ...
      var i = function(n) {
        ...
        return d = d || null, b = b || "&", u = u || null, n ? function(f) {
          ...
          if (u && (w = u + "[" + w + "]"), typeof n[f] == "object" && n[f] !== null) p = o(n[f], null, b, w);
            ...
            var v = n[f];
            v = (v = (v = (v = v === true ? "1" : v) === false ? "0" : v) === 0 ? "0" : v) || "", p = i(w) + "=" + i(v);
          }
          return p;
        })).join(b).replace(/[!'()*]/g, "") : "";
      };
...
var P = class _P {
   ...
   */
  renderSettings() {
    return _P.tunes.concat(this.config.actions || []).map((r) => ({
      icon: r.icon,
   ...
   */
  set data(a) {
    this.image = a.file, this._data.caption = a.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: r }) => {
      const c = typeof a[r] < "u" ? a[r] === true || a[r] === "true" : false;
      this.setTune(r, c);
    });
  }
  /**
