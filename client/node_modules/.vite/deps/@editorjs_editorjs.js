...
var St = ((n) => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(St || {});
var w = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
var d = class _d {
  ...
  static findAllInputs(e) {
    return Mt(e.querySelectorAll(_d.allInputsSelector)).reduce((t, o) => _d.isNativeInput(o) || _d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._d.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static isElement(e) {
    return mt(e) ? false : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return mt(e) ? false : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
...
var Rt = "fake cursor have been set";
...
var tt = class _tt extends y {
  ...
  getMethodsForTool(e, t) {
    return Object.assign(
      this.methods,
      {
        t: (o) => z.t(_tt.getNamespace(e, t), o)
      }
    );
  }
};
...
var yt = te("ce-popover-item-html");
var Et = {
  root: yt(),
...
var at = ((n) => (n.IsInline = "isInline", n.Title = "title", n))(at || {});
var Qe = ((n) => (n.IsTune = "isTune", n))(Qe || {});
var ct = class {
  /**
   * @class
...
var dt = class _dt {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : _dt.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = t.preserveBlank ?? false;
  }
  /**
...
var bs = class {
   ...
   */
  get(e) {
    const { class: t, isInternal: o = false, ...i } = this.config[e], s = this.getConstructor(t), r = t[Qe.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
var ys = class extends y {
  ...
  selectionChanged() {
    ...
    o.closest(`.${D.CSS.content}`) === null && (this.Editor.InlineToolbar.containsNode(o) || this.Editor.InlineToolbar.close(), !(o.dataset.inlineToolbar === "true")) || (this.Editor.BlockManager.currentBlock || this.Editor.BlockManager.setCurrentBlockByChildNode(o), this.Editor.InlineToolbar.tryToShow(true));
  }
  /**
