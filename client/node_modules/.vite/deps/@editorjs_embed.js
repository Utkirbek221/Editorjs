...
var m = class _m {
  ...
  render() {
    ...
    const { html: r } = _m.services[this.data.service], i = document.createElement("div"), e = document.createElement("div"), o = document.createElement("template"), l = this.createPreloader();
  ...
  onPaste(r) {
    var c;
    const { key: i, data: e } = r.detail, { regex: o, embedUrl: l, width: t, height: a, id: s = (u) => u.shift() || "" } = _m.services[i], h = (c = o.exec(e)) == null ? void 0 : c.slice(1), d = h ? l.replace(/<%= remote_id %>/g, s(h)) : "";
    this.data = {
      service: i,
      source: e,
      embed: d,
  ...
  static prepare({ config: r = {} }) {
    ...
    const o = Object.entries(i).filter(([t, a]) => typeof a == "boolean" && a === true).map(([t]) => t), l = Object.entries(i).filter(([t, a]) => typeof a == "object").filter(([t, a]) => _m.checkServiceConfig(a)).map(([t, a]) => {
    ...
    o.length && (e = e.filter(([t]) => o.includes(t))), e = e.concat(l), _m.services = e.reduce((t, [a, s]) => a in t ? (t[a] = Object.assign({}, t[a], s), t) : (t[a] = s, t), {}), _m.patterns = e.reduce((t, [a, s]) => (s && typeof s != "boolean" && (t[a] = s.regex), t), {});
  }
  /**
  ...
  static checkServiceConfig(r) {
    ...
    return s = s && (a !== void 0 ? a instanceof Function : true), s = s && (l !== void 0 ? Number.isFinite(l) : true), s = s && (t !== void 0 ? Number.isFinite(t) : true), s;
  }
  /**
