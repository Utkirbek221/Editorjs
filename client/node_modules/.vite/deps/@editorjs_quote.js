...
var i = class _i {
  ...
  constructor({ data: t, config: e, api: n, readOnly: r }) {
    const { ALIGNMENTS: o, DEFAULT_ALIGNMENT: s } = _i;
    this.api = n, this.readOnly = r, this.quotePlaceholder = e.quotePlaceholder || _i.DEFAULT_QUOTE_PLACEHOLDER, this.captionPlaceholder = e.captionPlaceholder || _i.DEFAULT_CAPTION_PLACEHOLDER, this.data = {
      text: t.text || "",
      caption: t.caption || "",
