...
var u = class _u {
  ...
  static isAtStart() {
    ...
    if (!e || e.focusOffset > 0)
      return false;
    const t = e.focusNode;
    return !t || !c(t) ? false : _u.getHigherLevelSiblings(t, "left").every((s) => C(s));
  }
  /**
...
var S = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="12" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.79999 14L7.79999 7.2135C7.79999 7.12872 7.7011 7.0824 7.63597 7.13668L4.79999 9.5"/></svg>';
var f = class _f {
  /**
  ...
  enterPressed(e) {
    ...
    if (e.stopPropagation(), e.preventDefault(), e.isComposing)
      return;
    const r = t ? this.getItemContent(t).trim().length === 0 : true, n = (t == null ? void 0 : t.parentNode) === this.nodes.wrapper, s = (t == null ? void 0 : t.nextElementSibling) === null;
    if (n && s && r) {
      this.getOutOfList();
      return;
    } else if (s && r) {
  ...
  backspace(e) {
    ...
    if (!h)
      return;
    u.focus(h, false), this.caret.save(), h.insertAdjacentHTML("beforeend", l);
    let o = t.querySelectorAll(
      `.${this.CSS.itemChildren} > .${this.CSS.item}`
    );
    o = Array.from(o), o = o.filter((a) => !a.parentNode || !c(a.parentNode) ? false : a.parentNode.closest(`.${this.CSS.item}`) === t), o.reverse().forEach((a) => {
  ...
  static joinRecursive(e) {
    return e.items.map((t) => `${t.content} ${_f.joinRecursive(t)}`).join("");
  }
  /**
...
//# sourceMappingURL=@editorjs_nested-list.js.map
