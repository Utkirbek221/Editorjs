...
// node_modules/@editorjs/translate-inline/dist/Translate.mjs
(function() {
  "use strict";
  try {
    if (typeof document != "undefined") {
      var t = document.createElement("style");
      t.appendChild(document.createTextNode("._rotate-cw_1gwtr_1{animation:_rotate-cw_1gwtr_1 .3s ease-in infinite}._rotate-ccw_1gwtr_5{animation:_rotate-ccw_1gwtr_5 .15s ease-out}@keyframes _rotate-cw_1gwtr_1{0%{transform:rotate(0)}to{transform:rotate(360deg)}}@keyframes _rotate-ccw_1gwtr_5{0%{transform:rotate(0)}to{transform:rotate(-360deg)}}")), document.head.appendChild(t);
    }
  } catch (e) {
...
var i = (r, t, e) => t in r ? o(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e;
...
var d = class {
  ...
  async surround(t) {
    ...
    this.toggleAnimatedButton("cw", false), s && (this.originalText = e, this.replaceText(t, s), this.select(t));
  }
  checkState() {
    return false;
  }
...
//# sourceMappingURL=@editorjs_translate-inline.js.map
