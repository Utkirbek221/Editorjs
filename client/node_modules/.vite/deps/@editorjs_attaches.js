        ...
        var p = function() {
          ...
          return t2 = e2, r2 = [{ key: "toolbox", get: function() {
            ...
            if (this.nodes.wrapper.appendChild(r3), void 0 !== t3.url) {
              var s2 = l("a", this.CSS.downloadButton, { innerHTML: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', href: t3.url, target: "_blank", rel: "nofollow noindex noreferrer" });
