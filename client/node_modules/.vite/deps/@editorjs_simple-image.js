...
var h = class {
  ...
  constructor({ data: t, config: e, api: r, readOnly: o }) {
    this.api = r, this.readOnly = o, this.blockIndex = this.api.blocks.getCurrentBlockIndex() + 1, this.CSS = {
      ...
      url: t.url || "",
      caption: t.caption || "",
      withBorder: t.withBorder !== void 0 ? t.withBorder : false,
      withBackground: t.withBackground !== void 0 ? t.withBackground : false,
      stretched: t.stretched !== void 0 ? t.stretched : false
    }, this.tunes = [
      {
        name: "withBorder",
        label: "Add Border",
